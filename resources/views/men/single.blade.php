    ...
    <div class="container">
        <div class="card-deck">
            <div class="card" id="card-5">
                    <img class="card-img-top rounded" src="{{ asset($men_product->image) }}" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title">{{ $men_product->name }}</h5>
                        <p class="card-text">€{{ $men_product->price }}</p>
                    </div>
