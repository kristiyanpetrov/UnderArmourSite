...
<section class="p-5 m-5">
    <div class="container">
        <div class="card-deck">
            <div class="card">
                <img class="card-img-top rounded" src="{{ asset($boy_product->image) }}" alt="Card image cap">
                <div class="card-body">
                    <h5 class="card-title">{{ $boy_product->name }}</h5>
                    <p class="card-text">€{{ $boy_product->price }}</p>
                </div>
