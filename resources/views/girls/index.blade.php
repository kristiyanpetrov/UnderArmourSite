...
<nav class="navbar navbar-expand-sm navbar-light bg-light fixed-top mt-0 ">
    ...
    <div class="collapse navbar-collapse ml-auto" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item px-2">
                <a href="/underarmour/public/girls/products" class="nav-link active">GIRLS</a>
            </li>
        </ul>
    ...
    <div class="container">
        <div class="card-deck">
            <div class="card" id="card-1">
                <a href="{{ route('girls.single', ['id' => $first_post->id]) }}">
            ...
            <div class="card" id="card-2">
                <a href="{{ route('girls.single', ['id' => $second_post->id]) }}">
            ...
            <div class="card" id="card-3">
                <a href="{{ route('girls.single', ['id' => $third_post->id]) }}">
        ...
        <div class="card-deck pt-5 ">
            <div class="card" id="card-4">
                <a href="{{ route('girls.single', ['id' => $forth_post->id]) }}">
            ...
            <div class="card" id="card-5">
                <a href="{{ route('girls.single', ['id' => $fifth_post->id]) }}">
            ...
            <div class="card" id="card-6">
                <a href="{{ route('girls.single', ['id' => $sixth_post->id]) }}">
