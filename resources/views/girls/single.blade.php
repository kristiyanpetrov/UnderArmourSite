...
<nav class="navbar navbar-expand-sm navbar-light bg-light fixed-top mt-0 ">
    ...
    <div class="collapse navbar-collapse ml-auto" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item px-2">
                <a href="/underarmour/public/girls/products" class="nav-link">WOMEN</a>
            </li>
            <li class="nav-item px-2">
    ...
    <div class="container">
        <div class="card-deck">
            <div class="card" id="card-5">
                <img class="card-img-top rounded" src="{{ asset($girls_product->image) }}" alt="Card image cap">
                <div class="card-body">
                    <h5 class="card-title">{{ $girls_product->name }}</h5>
                    <p class="card-text">€{{ $girls_product->price }}</p>
                </div>
