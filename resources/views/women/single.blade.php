    ...
    <div class="container">
        <div class="card-deck">
            <div class="card" id="card-5">
                <img class="card-img-top" src="{{ asset($women_product->image) }}" alt="Card image cap">
                <div class="card-body">
                    <h5 class="card-title">{{ $women_product->name }}</h5>
                    <p class="card-text">€{{ $women_product->price }}</p>
                </div>
